...
#/home/home02/ummz/github_dirs/RNA-seq/scripts/run-4-align.sh 'PE' /nobackup/ummz/analyses/run_12_Aug20/2_trimming_PE/processed_fastq/paired /nobackup/ummz/analyses/run_12_Aug20/4_alignment_PE_all/ /nobackup/ummz/reference_genome/generatedBySTAR_July20/index_allChr ${SGE_TASK_ID} >> /nobackup/ummz/analyses/run_12_Aug20/4_alignment_PE_all/arc_files/output.$JOB_ID.txt
